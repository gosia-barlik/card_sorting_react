...
role="dialog"
></div>`);
document.getElementById("root").appendChild(CreateNodeModal);
...
//       <div class="row">
//         <div class="large-12 columns">
//           <p style = "font-size: 12px">Node color</p>
//           <input type="radio" id="color1" name="color" value="1" />
//           <label
//             for="color1"
//             style="
...
//             for="color2"
//             style="
//               background-color: rgb(227, 253, 78);
//               padding: 4px 12px 4px 12px;
//               border-radius: 4px;
//             "
//             >yellow</label
...
//             for="color4"
//             style="
//               background-color: rgb(89, 131, 252);
//               padding: 4px 12px 4px 12px;
//               border-radius: 4px;
//             "
//             >blue</label
...
//         <div class="large-4 columns">
//           <a href="#" class="button info" onclick="close_edit_node_modal()"
//             >Cancel</a
//           >
//           <a href="#" class="button success" onclick="edit_node()">Save</a>
//         </div>
...
//         <div class="large-8 columns">&nbsp;</div>
//         <div class="large-4 columns">
//           <a href="#" class="button info" onclick="close_create_node_modal()"
//             >Cancel</a
//           >
//           <a href="#" class="button success" onclick="create_node()"
//             >Create</a
//           >
//         </div>
//       </div>
